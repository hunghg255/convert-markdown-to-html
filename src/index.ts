...
.v-popper--theme-twoslash.v-popper--theme-twoslash .twoslash-popup-error.twoslash-error-level-warning {
...
.twoslash-popup-docs.twoslash-popup-docs code {
  color: #8cccd5;
  border-radius: 4px;
  padding: 3px 6px;
  background-color: rgba(101, 117, 133, 0.16);
...
.v-popper--theme-twoslash.v-popper--theme-twoslash .twoslash-popup-docs-tags .twoslash-popup-docs-tag-name {
...
/* Icons */
.v-popper--theme-twoslash.v-popper--theme-twoslash .twoslash-completion-list .twoslash-completions-icon {
  color: var(--twoslash-unmatched-color);
  width: 1em;
  flex: none;
}
...
.v-popper--theme-twoslash.v-popper--theme-twoslash .twoslash-completion-list .twoslash-completions-icon svg {
  width: 10px;
  height: 10px;
}
